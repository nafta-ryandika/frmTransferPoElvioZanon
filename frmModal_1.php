<?php
  ...
  if(isset($_POST['inkdgol'])){
    $txtdatamodal = $_POST['inkdgol'];
  }
                ...
                <tr>
                  <td>
                    ...
                    <select id="txtfieldmodal">
                        <option value="">-</option>
                        <option selected value="kdgol">Kode Golongan Sepatu</option>
                        <option value="nmgol">Nama Golongan Sepatu</option>
                    </select>
                  </td>
                  <td>
