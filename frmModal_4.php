<?php
  ...
  if(isset($_POST['inkdjenissepatu'])){
    $txtdatamodal = $_POST['inkdjenissepatu'];
  }
                ...
                <tr>
                  <td>
                    ...
                    <select id="txtfieldmodal">
                        <option value="">-</option>
                        <option selected value="kdjenis">Kode Jenis Sepatu</option>
                        <option value="nmjenis">Nama Jenis Sepatu</option>
                    </select>
                  </td>
                  <td>
