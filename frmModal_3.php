<?php
  ...
  if(isset($_POST['inkdwarna'])){
    $txtdatamodal = $_POST['inkdwarna'];
  }
                ...
                <tr>
                  <td>
                    ...
                    <select id="txtfieldmodal">
                        <option value="">-</option>
                        <option selected value="kdwarna">Kode Warna</option>
                        <option value="nmwarna">Nama Warna</option>
                    </select>
                  </td>
                  <td>
