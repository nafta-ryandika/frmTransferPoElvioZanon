<?php
  ...
  if($_POST['txtfield']!=''){
        ...
        $like_data = getsearchdata('kmjeniskulit ',$txtfield,$txtdata);
      		...
      		<table id="myTableModal1" class="tablesorter">
                  <thead>
                    <tr>
                      ...
                      <th align="center">Kode Jenis Kulit</th>
                      <th align="center">Nama Jenis Kulit</th>
                      <th align="center">...</th>
                    </tr>
                  </thead>
		  <tbody>
              <?php
                $sqlCOUNT = "SELECT kdjenis, nmjenis FROM DBKMBS.kmjeniskulit WHERE 1";
                $sqlCOUNT = $sqlCOUNT.$sqlWHERE;
                $result=mysql_query($sqlCOUNT);
                $count=mysql_num_rows($result);
                mysql_free_result($result);

                $sql="SELECT kdjenis, nmjenis FROM DBKMBS.kmjeniskulit WHERE 1";
